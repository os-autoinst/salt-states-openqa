...
grub-conf-cmdline:
  file.replace:
    ...
    - repl: 'GRUB_CMDLINE_LINUX_DEFAULT="{{ ttyconsolearg }} nospec kvm.nested=1 kvm_intel.nested=1 kvm_amd.nested=1 kvm-arm.nested=1 nvme-core.multipath=N {{ additional_linux_cmdline_args }}"'
    - append_if_not_found: True
