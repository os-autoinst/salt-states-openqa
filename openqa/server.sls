  ...
  ini.options_present:
    - sections:
        ...
        misc_limits:
          ...
          asset_cleanup_max_free_percentage: 16
        obs_rsync:
        ...
        hooks:
          ...
          job_done_hook_failed: env host=openqa.suse.de exclude_group_regex='.*(Development|Public Cloud|Released|Others|Kernel|Virtualization).*' /opt/os-autoinst-scripts/openqa-label-known-issues-and-investigate-hook
