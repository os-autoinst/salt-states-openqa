...
{% set provisioned_alerts = ['stacked-backlog-no-data.yaml', 'dashboard-automatic-actions.yaml', 'failed-systemd-services.yaml', 'dashboard-job-age.yaml', 'dashboard-monitoring.yaml', 'dashboard-openqa-jobs-test.yaml', 'dashboard-WebuiDb.yaml', 'inodes.yaml', 'http_response_codes.yaml', 'network-availability.yaml', 'deployment-run-time.yaml'] %}
