...
{% set manual_dashboardnames = ['webui.dashboard.json', 'failed_systemd_services.json', 'automatic_actions.json', 'job_age.json', 'openqa_jobs.json', 'status_overview.json', 'monitoring.json', 'maintenance_update_queue.json', 'agile.dashboard.json', 'sap_perf_gitlab_commits.json', 'sleperf_metrics.json'] %}
...
{% set provisioned_alerts = ['stacked-backlog-no-data.yaml', 'dashboard-automatic-actions.yaml', 'failed-systemd-services.yaml', 'dashboard-job-age.yaml', 'dashboard-monitoring.yaml', 'dashboard-openqa-jobs-test.yaml', 'dashboard-WebuiDb.yaml', 'inodes.yaml', 'http_response_codes.yaml', 'network-availability.yaml'] %}
